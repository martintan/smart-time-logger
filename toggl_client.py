...
class TogglClient:
    ...
    def __init__(self, api_token: Optional[str] = None):
        ...
        if not self.api_token:
            raise ValueError("Toggl API token is required. Set TOGGL_API_TOKEN environment variable or pass api_token parameter.")
    ...
    def get_time_entries(self, start_date: Optional[str] = None, end_date: Optional[str] = None) -> List[Dict[str, Any]]:
        """
    ...
    def create_time_entry(self, description: str, start: str, duration: int, 
                         project_id: Optional[int] = None, tag_ids: Optional[List[int]] = None) -> Dict[str, Any]:
        """
        ...
        return self._make_request('POST', f'workspaces/{self.workspace_id}/time_entries', json=data)
